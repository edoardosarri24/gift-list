...
\begin{itemize}
    ...
    Registers or identifies a guest's email for a specific list. If the email already exists for this list, it refreshes the guest session. The backend stores the email and sets a secure, \texttt{HttpOnly} session cookie.
...
\begin{itemize}
    ...
    \item \texttt{GET /lists/:id/manage} \\
